<script>
    ...
    import Pogi from "../../image/pogi.jpg";
    import BoxesAccounts from '../../components/BoxesAccounts.svelte';
    import Registrar from '../../components/registrars.svelte';
...
<div class="h-[105vh] w-full bg-slate-300">
    ...
    <div class="ml-[300px] p-5 ">
      ...
      <div class="h-[200px] w-[200] flex gap-x-5">
        ...
        <div class="h-[260%] w-[80%] bg-slate-100  mt-3 rounded-md shadow-md p-5">
              ...
              <div class="modal-box">
                ...
                <div class="modal-action">
                  <form method="dialog">
                    ...
                    <button onclick="my_modal_2.showModal()" class="btn">Yes</button>
            ...
            <dialog id="my_modal_4" class="modal modal-bottom sm:modal-middle">
              <div class="modal-box">
                ...
                <div class="modal-action">
                  <form method="dialog">
                    <!-- if there is a button in form, it will close the modal -->
                    <button onclick="my_modal_1.showModal()" class="btn">Yes</button>
                    <button class="btn">Close</button>
